<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Dz1_zad1.Default" %>
...
<body class="body_form">
    <form class="form1" id="form1" runat="server" >
        <div class="div_form">
            ...
            <asp:DropDownList CssClass="Uroven_form" ID="DropDownList1" runat="server" BackColor="#052530" ForeColor="White">
            ...
            <br/>
            <asp:Button CssClass="button_add" ID="Button1" runat="server" Text="Добавить" OnClick="Button1_OnClick" />
            <asp:HyperLink CssClass="link_button" ID="HyperLink1" runat="server">Перейти к таблице</asp:HyperLink>
            <br/>
        </div>
    </form>
</body>
